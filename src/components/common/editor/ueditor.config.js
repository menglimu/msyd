...
(function () {
  ...
  var rPath = "https://static.mszhuanzhuan.com/images/"
  ...
  window.UEDITOR_CONFIG = {
    ...
    ,imagePath: rPath                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
    ...
    ,videoPath: rPath                   //附件修正地址，同imagePath
